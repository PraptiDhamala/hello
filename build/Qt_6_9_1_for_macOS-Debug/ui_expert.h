...
public:
    ...
    void setupUi(QMainWindow *expert)
    {
        ...
        label->setGeometry(QRect(290, 29, 241, 31));
        label->setStyleSheet(QString::fromUtf8("QLabel\n"
"{\n"
"font-size: 24px; \n"
"color: white; \n"
"	font: 24pt \"Baskerville\";\n"
"allignment:center;\n"
"}"));
        InsightBox = new QLabel(centralwidget);
        InsightBox->setObjectName("InsightBox");
        InsightBox->setGeometry(QRect(200, 100, 471, 71));
...
"}"));
        ...
        verticalLayoutWidget->setGeometry(QRect(150, 210, 571, 231));
        ...
        btnRefresh->setGeometry(QRect(290, 470, 251, 51));
